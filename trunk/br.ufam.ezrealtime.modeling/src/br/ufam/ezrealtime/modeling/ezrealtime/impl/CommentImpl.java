 ...
 * <ul>
 *   <li>{@link br.ufam.ezrealtime.modeling.ezrealtime.impl.CommentImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommentImpl extends ModelElementImpl implements Comment {
	...
	protected EClass eStaticClass() {
		return EZRealtimePackage.Literals.COMMENT;
	}
	...
	public void setBody(String newBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EZRealtimePackage.COMMENT__BODY, oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EZRealtimePackage.COMMENT__BODY:
				return getBody();
		}
