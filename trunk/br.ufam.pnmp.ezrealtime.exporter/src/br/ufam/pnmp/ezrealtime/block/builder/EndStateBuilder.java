 ...
 * </copyright>
 *
 * $Id: EndStateBuilder.java,v 1.2 2008/01/20 15:48:44 fabianocruz Exp $
 */
...
public class EndStateBuilder extends BlockBuilder {

	private EndStateBlock endStateBlock;

	public void buildBase() {
		System.out.println("Building End State block");
		endStateBlock = (EndStateBlock) BlockFactory
				.getBuildingBlock(BlockType.END_STATE);
	}
