 ...
 * </copyright>
 *
 * $Id: InitialStateBuilder.java,v 1.2 2008/01/20 15:48:44 fabianocruz Exp $
 */
...
public class InitialStateBuilder extends BlockBuilder {

	private InitialStateBlock initialStateBlock;

	public void buildBase() {
		System.out.println("Building Initial State block");
		initialStateBlock = (InitialStateBlock) BlockFactory
				.getBuildingBlock(BlockType.INITIAL_STATE);
	}
