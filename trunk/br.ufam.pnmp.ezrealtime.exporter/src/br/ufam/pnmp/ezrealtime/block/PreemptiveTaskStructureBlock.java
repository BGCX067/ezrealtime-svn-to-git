 ...
 * </copyright>
 *
 * $Id: PreemptiveTaskStructureBlock.java,v 1.2 2008/01/20 15:48:44 fabianocruz Exp $
 */
...
public class PreemptiveTaskStructureBlock extends Block {
	...
	public PreemptiveTaskStructureBlock() {
	...
	public void writeBlock(Page page, Task task, PlaceOffsetAndPosition pos) {
		...
		toolInfo.setFromTime("1");
		toolInfo.setToTime("1");
		 ...
		 */
		{
			...
			netBuilder.writeArc(page, ds, "pwr-tr-" + task.getName(), source,
					target, posArray, task.getComputing());
