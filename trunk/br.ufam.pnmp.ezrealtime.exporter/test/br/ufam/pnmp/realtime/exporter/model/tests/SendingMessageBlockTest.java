...
public class SendingMessageBlockTest {

	private static EZRealtimeSpec realtimeSystem;
	private static SendingMessageBlock sendingMessageBlock;
	...
	public static void setUpBeforeClass() throws Exception {
		System.out.println("SendingMessageBlockTest.setUpBeforeClass()");
	...
	public void setUp() throws Exception {
		...
		sendingMessageBlock = new SendingMessageBlock();
		// TODO review
	...
	@Test
	public void testSendingMessageBlock() {
		try {
			sendingMessageBlock = new SendingMessageBlock();
	...
	public void testGetType() {
		if (sendingMessageBlock == null) {
			fail("Sending Message Block not initialized yet!");
		}
		BlockType type = sendingMessageBlock.getType();
		if (type == null) {
			fail("Sending Message Block type is null");
		} else if (type != BlockType.SENDING_MESSAGE) {
	...
	public static void tearDownClass() {
		...
		try {
			...
			final String PNML_FILE_NAME = "output/sendingmessageblock.xml";
