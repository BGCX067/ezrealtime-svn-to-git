 ...
 */
public class RealTimeDiagramEnergyPageCanvas extends Canvas implements IPropertySource {
	...
	private String maxWidth = "600";
	private String maxHeight = "400";
	 ...
	 * @param style
	 */
	public RealTimeDiagramEnergyPageCanvas(Composite parent, int style) {
		super(parent, style);
		...
		this.plotColor = new Color(null, 200, 200, 0);
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		ColorPropertyDescriptor gridColorDescriptor = new ColorPropertyDescriptor(
				"grid", "Grid");
		ColorPropertyDescriptor plotColorDescriptor = new ColorPropertyDescriptor(
				"plot", "Plot");
		...
		plotColorDescriptor.setCategory("Color");
		...
		TextPropertyDescriptor maxWidthDescriptor = new TextPropertyDescriptor("maxWidth","Max Width");
		TextPropertyDescriptor maxHeightDescriptor = new TextPropertyDescriptor("maxHeight","Max Height");
		
		return new IPropertyDescriptor[] { backgroundColorDescriptor,
				axesColorDescriptor, maxWidthDescriptor, maxHeightDescriptor, gridColorDescriptor,
				labelsColorDescriptor, plotColorDescriptor, printHorizontalGridDescriptor, printVerticalGridDescriptor };
	}
	...
	public void setPropertyValue(Object id, Object value) {
		...
		if (id.equals("background")) {
			...
			this.plotColor.dispose();
			this.plotColor = new Color(null, (RGB) value);
		} else if (id.equals("labels")) {
			...
			this.maxWidth = value.toString();
		} else if (id.equals("maxHeight")) {
			this.maxHeight = value.toString();
		} else if (id.equals("printVerticalGrid")) {
