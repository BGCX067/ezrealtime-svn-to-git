 ...
 * <ul>
 *   <li>{@link br.ufam.pnmp.ezrealtime.impl.ProcessorImpl#getOid <em>Oid</em>}</li>
 *   <li>{@link br.ufam.pnmp.ezrealtime.impl.ProcessorImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessorImpl extends EObjectImpl implements Processor {
	...
	protected EClass eStaticClass() {
		return EZRealtimePackage.Literals.PROCESSOR;
	}
	...
	public void setOid(String newOid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EZRealtimePackage.PROCESSOR__OID, oldOid, oid));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EZRealtimePackage.PROCESSOR__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EZRealtimePackage.PROCESSOR__OID:
			return getOid();
		case EZRealtimePackage.PROCESSOR__NAME:
			return getName();
		}
