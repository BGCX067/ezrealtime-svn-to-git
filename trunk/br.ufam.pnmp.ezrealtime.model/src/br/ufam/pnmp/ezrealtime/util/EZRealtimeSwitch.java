...
public class EZRealtimeSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EZRealtimePackage.EZ_REALTIME_SPEC: {
			EZRealtimeSpec ezRealtimeSpec = (EZRealtimeSpec) theEObject;
			T result = caseEZRealtimeSpec(ezRealtimeSpec);
			if (result == null)
	 ...
	 * @generated
	 */
	public T caseEZRealtimeSpec(EZRealtimeSpec object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Source Code</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
