 ...
 * <!-- end-user-doc -->
 * @see br.ufam.pnmp.ezrealtime.util.EZRealtimeResourceImpl
 * @generated
 */
public class EZRealtimeResourceFactoryImpl extends ResourceFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public EZRealtimeResourceFactoryImpl() {
		super();
	}
	...
	public Resource createResource(URI uri) {
		XMLResource result = new EZRealtimeResourceImpl(uri);
