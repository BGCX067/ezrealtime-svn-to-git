...
public class InterfacePropertiesBlock extends MasterDetailsBlock {
	private FormPage page;

	public InterfacePropertiesBlock(FormPage page) {
		this.page = page;
	}

	class MasterContentProvider implements IStructuredContentProvider {
		public Object[] getElements(Object inputElement) {
			if (inputElement instanceof EBundleEditorInput) {
				EBundleEditorInput input = (EBundleEditorInput) page
