...
import br.ufam.ezrealtime.ebundle.model.TypeOne;
...
public class TypeOneDetailsPage implements IDetailsPage {
	...
	private Button flag;
	private Text text;
	private static final String RTEXT_DATA = "<form><p>An example of a free-form text that should be "
	 ...
	 * (non-Javadoc)
	 * 
	 * @seeorg.eclipse.ui.forms.IDetailsPage#initialize(org.eclipse.ui.forms.
	 * IManagedForm)
	 */
	...
	public void createContents(Composite parent) {
		...
		for (int i = 0; i < TypeOne.CHOICES.length; i++) {
			choices[i] = toolkit.createButton(client, TypeOne.CHOICES[i],
					SWT.RADIO);
		...
		flag = toolkit.createButton(client, "Value of the flag property",
				SWT.CHECK);
